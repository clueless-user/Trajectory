...
| goals | GoalRepository (CRUD; hard delete) | useHierarchyStore | ProjectsView (goal nodes between areas and projects) | was schema-only/unreachable until the hierarchy-CRUD pass |
